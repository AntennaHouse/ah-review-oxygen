...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- Auto Generated element/@outputclass from delete processing-instruction -->
    <xsl:variable name="cOutputClassForAutoGeneratedElemFromDeletePi" as="xs:string" static="yes" select="'__delete_auto_generated'"/>
